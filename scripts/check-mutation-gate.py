#!/usr/bin/env python3
"""Run mutmut against llmwiki_service/auth.py and tokens.py and fail when a
mutant survives that scripts/mutation-survivor-baseline.txt does not name.
...
def main(argv: list[str]) -> int:
    del argv  # no arguments; matches check-plan-citations.py's shape
    run_mutmut()
